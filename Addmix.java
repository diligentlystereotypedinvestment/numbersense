...
public class Addmix
{
	...
	String summix =
		"$" + fracOperations.properAdd ((addmix * addfracd + addfracn) + "/" +
				addfracd,
				(addmix2 * addfracd2 + addfracn2) + "/" +
				addfracd2) + "$";
	double dmix =
		(addmix + (addfracn / addfracd)) - (addmix2 + (addfracn2 / addfracd2));
	double pmix =
		(addmix / 100 + (addfracn / addfracd)) * (addmix2 / 100 +
				(addfracn2 / addfracd2));
	double qmix =
		(addmix / 100 + (1.000 * addfracn / addfracd)) / (addmix2 / 100 +
				(1.000 * addfracn2 /
				 addfracd2));
}
