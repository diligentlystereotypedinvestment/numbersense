...
public class multshort
{
	...
	public String multishort ()
	{
		...
		i++;
		if (choose == i)
		{				// fraction of 1000(333.3333, 125, 166.6666, 375, 666.6666, 111.11111)
		...
		{				// factoring of numerical problems
			...
			{
				double beforeMult =
					(rand.nextInt (40) + 1) / (10 * rand.nextInt (2));
				int scalar = 3 * rand.nextInt (2) + 2;
				problem =
					"$" + (beforeMult * scalar) + "^2 + " + beforeMult + "^2 = $";
			...
			if (chooser == 2)
			{
				...
				problem =
					"$" + multicand + " + " + small + "\\times" + multicand +
					" = $";
			...
			if (chooser == 4)
			{
				...
				{
					problem =
						"$" + add1 + " \\times " + (2000 + differ2000) + " + " +
						add2 + " \\times " + (2000 + differ2000) + " = $";
		...
		{				// mixed numbers
			...
			if (chooser == 1)
			{
				...
				problem =
					"$" + wholeNum + "\\frac{" + num + "}{" + denom + "} \\times" +
					wholeNum + "\\frac{" + (denom - num) + "}{" + denom + "} = ";
				fullAnswer =
					fracOperations.properMult ((wholeNum + " " + num + "/" + denom),
							(wholeNum + " " + (denom - num) +
							 "/" + denom));
			}
			if (chooser == 2)
			{
				...
				problem =
					"$" + wholeNum + "\\frac{" + num + "}{" + denom + "} \\times" +
					wholeNum * scalar + "\\frac{" + num + "}{" + denom + "} = ";
				fullAnswer =
					fracOperations.properMult ((wholeNum + " " + num + "/" + denom),
							(wholeNum * scalar + " " + num +
							 "/" + denom));
