...
public class OofO
{
	...
	public static void baseGen (ArrayList < String > questions,
			ArrayList < String > answers, int i)
	{
		...
		{				//addition
			...
			questions.add ("(" + i + ") $" + baseconvert.newnum (first, base) +
					"_" + base + " + " + baseconvert.newnum (second,
						base) + "_" +
					base + "= \\hrulefill_" + base + "$");
		...
		{				//multiplication
			...
			questions.add ("(" + i + ") $" + baseconvert.newnum (first, base) +
					"_" + base + " \\cdot " + baseconvert.newnum (second,
						base) +
					"_" + base + "= \\hrulefill_" + base + "$");
			answers.add (baseconvert.newnum (first * second, base));
		}
		if (sign == 3)
		{				//division
			...
			questions.add ("(" + i + ") $" + baseconvert.newnum (first, base) +
					"_" + base + "\\div" + baseconvert.newnum (second,
						base) +
					"_" + base + "= \\hrulefill_" + base + "$");
			answers.add (baseconvert.newnum (first / second, base));
		}
	...
	public String genOp (Object add, Object mult, Object div, boolean first)
	{
		...
		if (first)
		{
			...
			{
				answer =
					fracOperations.fracDivide (toAns (div), toAns (div), false);
