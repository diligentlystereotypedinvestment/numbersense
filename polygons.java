...
class polygons
{
			...
			ArrayList < String > answers, int i)
	{
		...
		{				//equilateral triangle
			...
			{			//height
				questions.add ("(" + i +
						") What is the height of a triangle with a side length of "
						+ sideLength + "?");
			...
			{			//area
				questions.add ("(" + i +
						") What is the area of a triangle with a side length of "
						+ sideLength + "?");
				answers.add ("$" +
						simplify.getFraction ((int) Math.
							pow (sideLength, 2) + "/" + 4,
							false) + "\\cdot\\sqrt{3}$");
			}
			if (problem == 2)
			{			//side length from area
				questions.add ("(" + i +
						") What is the side length of a triangle with an area of $"
						+
						simplify.getFraction ((int) Math.
							pow (sideLength,
								2) + "/" + 4,
		...
		{				//rectangle
			...
			{			//diagonals
				questions.add ("(" + i +
						") What is the diagonal length of a square  with an area of "
			...
			{			//perimeter
				questions.add ("(" + i +
						") What is the perimeter of a rectangle with a diagonal of "
						+ sideLength + "$\\sqrt{2}$?");
			...
			{			//area ratios
				...
				questions.add ("(" + i + ") Rectangle ABCD is " + sideLength +
						"\" by " + side2 +
						"\" and rectangle A\'B\'C\'D\' is " + side3 +
						"\" by" + side4 +
						"\" What is the ratio of the area of A to B?");
				answers.add (String.
						valueOf (simplify.
							getFraction ((sideLength * side2) + "/" +
								(side3 * side4))));
			}
		}
	...
	public void gen2 (ArrayList < String > questions,
			ArrayList < String > answers, int i)
	{
		Random rand = new Random ();
		...
		{				//pentagons
			...
			if (problem == 0)
			{			//area
				questions.add ("(" + i + ") What is the area of a " +
						penta.getName () + " with a side length of " +
						sideLength + " and an apothem of " +
						penta.getApothem () + "?");
				answers.add (String.valueOf (penta.getArea ()));
			}
			if (problem == 1)
			{			//perimeter
				questions.add ("(" + i + ") What is the perimeter of a " +
						penta.getName () + "with a side length of " +
						sideLength);
			...
			if (problem == 3)
			{
				questions.add ("(" + i + ") What is the center angle of a " +
						penta.getName () + "?");
		...
		nagon.gen (sides, sideLength, tracker, 10, "decagon", questions, answers,
				i);
		tracker++;
		nagon.gen (sides, sideLength, tracker, 11, "undecagon", questions,
				answers, i);
		tracker++;
		nagon.gen (sides, sideLength, tracker, 12, "dodecagon", questions,
				answers, i);
