...
public class coord
{
			...
			ArrayList < String > answers, int i)
	{
		...
		{				//solve for x
			...
			{			//reflect over y axis
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the y-axis onto $(h, " + y +
						")$ What is $h$?");
			...
			{			//reflect over x axis
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the x-axis onto $(h, " +
						-1 * y + ")$ What is $h$?");
			...
			{			//reflect over y = x
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the line $y = x$ onto $(h, "
						+ x + ")$ What is $h$?");
		...
		{				//solve for y
			...
			{			//reflect over y axis
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the y-axis onto $(" +
						-1 * x + ", h)$ What is $h$?");
				answers.add (String.valueOf (y));
			}
			if (choose == 1)
			{			//reflect over x axis
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the x-axis onto $(" + x +
						", h)$ What is $h$?");
				answers.add (String.valueOf (-1 * y));
			}
			if (choose == 2)
			{			//reflect over y = x
				questions.add ("(" + i + ") The point $(" + x + ", " + y +
						")$ is reflected over the line $y = x$ onto $(" +
						y + ", h)$ What is $h$?");
				answers.add (String.valueOf (x));
			}
			if (choose == 3)
