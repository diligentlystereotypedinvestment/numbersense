...
public class complexNum {
	...
	public static complexNum divide(complexNum divisor, complexNum dividend) {
		...
		int denom = Integer.valueOf(multiply(dividend,
				new complexNum(dividend.getReal(), String.valueOf(-1 * Integer.valueOf(dividend.getImaginary()))))
						.toString().substring(2));
		complexNum quotient = new complexNum(simplify.getFraction(product.getReal() + "/" + denom),
				simplify.getFraction(product.getReal() + "/" + denom));
		return quotient;
	}
