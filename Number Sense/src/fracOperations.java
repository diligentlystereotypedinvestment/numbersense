...
public class fracOperations
{
	...
	public fracOperations simp (fracOperations unSimp)
	{
		...
		{
			return new fracOperations (unSimp.getNum () /
					LCMandGCF.GCF (unSimp.getNum (),
						unSimp.getDenom ()),
					unSimp.getDenom () /
					LCMandGCF.GCF (unSimp.getNum (),
						unSimp.getDenom ()));
	...
	public fracOperations add (fracOperations frac1, fracOperations frac2)
	{
		...
		return simp (new
				fracOperations (num1 * denom2 + num2 * denom1,
					denom1 * denom2));
	}
	...
	public static String fracDivide (String frac1, String frac2,
			boolean latexFormat)
	{
		frac1 = verifyFrac (frac1);
		frac2 = verifyFrac (frac2);
	...
	public static String properMult (String frac1, String frac2)
	{
		...
		answer[0] =
			String.valueOf (Integer.valueOf (parts1[0]) *
					Integer.valueOf (parts2[0])) + "/1";
		...
		return simplify.
			getProper (fracAdd
					(fracAdd (answer[0], answer[1], false),
					 fracAdd (answer[2], answer[3], false), false));
	}
