...
class nagon
{
	...
	public nagon (int sides, int sideLength, String name)
	{
		...
		this.area =
			Double.valueOf (eliminateZero.zero (this.apothem * perimeter / 2.0));
	}
	...
	{
		return simplify.getFraction (360 + "/" + sides);
	}
	public static void gen (int sides, int sideLength, int tracker,
			int realPolySides, String name,
